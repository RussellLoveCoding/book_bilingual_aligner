...
> ★★ **2026-09-18 12:xx（§6.17）两个解析器 fix 之后的当前值以此为准**：
> 段落对 **5721** · **命中中文 4571** · 待补 **1150** · 告警 **1907** ·
> `dbg_bookscan` 前缀 **0** / 泄漏 **0** / 缺中文 **805** ·
> `dbg_qa` 连续同侧 **132** · `dbg_eqcheck` **exit 0**。
> 下面这段是 §6.17 之前的存档，**已被上表取代**。
